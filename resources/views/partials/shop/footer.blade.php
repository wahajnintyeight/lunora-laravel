            ...
            <div class="col-span-1 sm:col-span-2 lg:col-span-1">
                ...
                <form class="mb-6">
                    <div class="flex flex-col sm:flex-row gap-2">
                        ...
                        <button type="submit" class="py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-emerald-600 text-white hover:bg-emerald-700 focus:outline-none focus:bg-emerald-700 disabled:opacity-50 disabled:pointer-events-none transition-colors">
                            Subscribe
                        </button>
                    </div>
