            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <a href="{{ route('admin.pages.show', $page) }}" class="ml-1 text-gray-500 hover:text-gray-700 dark:text-neutral-400 dark:hover:text-neutral-200">{{ $page->title }}</a>
                    </div>
                </li>
                <li>
                    <div class="flex items-center">
            ...
            <div class="p-6 space-y-6">
                ...
                <div>
                    ...
                    <div class="flex">
                        ...
                        <input type="text" id="slug" name="slug" value="{{ old('slug', $page->slug) }}" class="py-3 px-4 block w-full border-gray-200 rounded-e-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600" required>
                    </div>
                    @error('slug')
                        <p class="text-sm text-red-600 mt-2">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    ...
                    <div class="flex justify-between items-center mt-1">
                        ...
                        <span id="meta-counter" class="text-xs text-gray-500 dark:text-neutral-400">{{ strlen($page->meta_description ?? '') }}/160</span>
                    </div>
                ...
                <div>
                    <div class="flex items-center">
                        ...
                        <input type="checkbox" id="is_published" name="is_published" value="1" {{ old('is_published', $page->is_published) ? 'checked' : '' }} class="shrink-0 mt-0.5 border-gray-200 rounded text-blue-600 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-800 dark:border-neutral-700 dark:checked:bg-blue-500 dark:checked:border-blue-500 dark:focus:ring-offset-gray-800">
