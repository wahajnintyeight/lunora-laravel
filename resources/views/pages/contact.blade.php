    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 pt-12 pb-16 lg:pt-20 lg:pb-24">
        <div class="max-w-6xl mx-auto">
            <div class="text-center mb-16 sm:mb-20">
                ...
                <p class="text-lg sm:text-xl text-gray-600 mb-6">We'd love to hear from you. Get in touch with our team.</p>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16">
                ...
                <div class="bg-white rounded-xl shadow-lg p-8 sm:p-10">
                    ...
                    <form action="#" method="POST" class="space-y-6">
                        ...
                        <button type="submit" 
                                class="w-full bg-gold-500 text-white py-4 px-6 rounded-xl font-bold text-lg shadow-lg hover:shadow-xl hover:bg-gold-600 hover:-translate-y-0.5 focus:ring-2 focus:ring-gold-500 focus:ring-offset-2 transition-all duration-200">
                            Send Message
                        </button>
                    </form>
                </div>
                ...
                <div class="space-y-8">
                    <div class="bg-white rounded-xl shadow-lg p-8 sm:p-10">
                        ...
                        <div class="space-y-7">
                            <div class="flex items-start gap-4">
                                <div class="w-14 h-14 bg-gold-500 rounded-full flex items-center justify-center flex-shrink-0 shadow-md">
                    ...
                    <div class="bg-white rounded-xl shadow-lg p-8 sm:p-10">
                        ...
                        <div class="flex gap-5">
                            <a href="#" class="w-14 h-14 bg-gold-500 rounded-full flex items-center justify-center text-white hover:bg-gold-600 shadow-md hover:shadow-lg transition-all duration-200 text-lg">
